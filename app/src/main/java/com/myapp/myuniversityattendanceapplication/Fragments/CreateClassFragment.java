...
import com.myapp.myuniversityattendanceapplication.Adapters.CreateClassAdapter;
...
public class CreateClassFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        createClassBtn.setOnClickListener(view1 -> {
            ...
            if (className.isEmpty()) {
                ...
                String key = Objects.requireNonNull(databaseReference.push().getKey()).toString();
